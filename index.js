...
// Route Level Middleware (single level middleware)
...
const upload=multer({
      storage:multer.diskStorage({
            destination:function(req,file,callBack){
                  callBack(null,"uploads") //We upload files in uploads folder
            },
            filename:function(req,file,callBack){
                  callBack(null,file.filename + "-" + Date.now() + ".jpg") // we set file with filename which is current data with jpg extension.
            }
      })
}).single("user_file") // we write name by API , it means I upload file by API and take name

app.post('/upload',upload,(req,res)=>{ // Here I wrote  upload
      res.send("Files uploading")
});
